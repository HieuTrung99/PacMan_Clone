...
public class Packman extends Game {
	...
	public Packman() {
		...
		try {
			packman = ImageIO.read(Packman.class.getResource("/images/packman.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
...
//		System.out.println(column*2 -14);
		g.drawImage(packman.getSubimage((frame / 2) * 30, (curDir - 37) * 30, 28, 28), column * STEP -14,
				row * STEP -14, null);
	}
